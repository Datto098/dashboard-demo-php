            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"><a href="add_manu.php"> <i class="icon-plus"></i>
                                </a></span>
                            <h5>Manufacture</h5>
                        </div>
                        <div class="widget-content nopadding">
                            <table class="table table-bordered
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="">
                                            <td width="100"><img src="./images/<?= $value["manu_image"] ?>"></td>
                                            <td><?= $value["manu_name"] ?>"></td>

                                            <td>
                                                <a href="edit_manu.php" class="btn
