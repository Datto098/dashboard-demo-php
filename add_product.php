...
if (isset($_POST['name']) && isset($_POST['manu_id']) && isset($_POST['price']) && isset($_POST['description']) && isset($_POST['feature']) && isset($_FILES['fileUpload']) && isset($_POST['type_id'])) {
    $target_dir = "images/";
    ...
    if ($upload_ok) {
        ...
        if ($upload_done) {
            ...
            if ($product->addProduct($name, $menu_id, $type_id, $price, $filename, $description, $feature)) {
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="type_id" id="subcate">
                                            ...
                                            ?>
                                                <option value="<?= $protypeItem["type_id"] ?>">
